const episodes = [
    ...
    { season: 3, episode: 17, title: "The Boyfriend, Part&nbsp;I", description: "Jerry befriends baseball star Keith Hernandez, who takes an interest in Elaine. George concocts an unemployment scheme involving 'Vandelay Industries.'<br><em>n.b. This is a double header, so you should watch Episode&nbsp;18: 'The Boyfriend, Part&nbsp;II' next.</em>" },
    { season: 3, episode: 18, title: "The Boyfriend, Part&nbsp;II", description: "Jerry befriends baseball star Keith Hernandez, who takes an interest in Elaine. George concocts an unemployment scheme involving 'Vandelay Industries.'<br><em>n.b. This is a double header, so you should watch Episode&nbsp;17: 'The Boyfriend, Part&nbsp;I' first.</em>" },
    ...
    { season: 4, episode: 1, title: "The Trip, Part&nbsp;I", description: "George and Jerry go to LA for Jerry to appear on the Tonight Show. Kramer struggles to land acting roles. George annoys George Wendt and Corbin Bernsen.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;2: 'The Trip, Part&nbsp;II' next.</em>" },
    { season: 4, episode: 2, title: "The Trip, Part&nbsp;II", description: "After Kramer is detained in LA as a suspect in a string of murders, George and Jerry try to clear Kramer's name and reunite with their friend.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;1: 'The Trip, Part&nbsp;I' first.</em>" },
    { season: 4, episode: 3, title: "The Pitch", description: "Jerry and George develop a sitcom pitch for NBC, and George dates a network executive. Kramer is kicked in the head. Newman gets a speeding ticket.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;4: 'The Ticket' next.</em>" },
    { season: 4, episode: 4, title: "The Ticket", description: "Jerry and George develop a sitcom pitch for NBC, and George dates a network executive. Kramer is kicked in the head. Newman gets a speeding ticket.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;3: 'The Pitch' first.</em>" },
    { season: 4, episode: 5, title: "The Wallet", description: "Morty claims a doctor stole his wallet. Elaine attempts to break up with her psychiatrist boyfriend. George negotiates the pilot deal with NBC.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;6: 'The Watch' next.</em>" },
    { season: 4, episode: 6, title: "The Watch", description: "Jerry tries to buy his old watch back from Uncle Leo. George makes a desperate plea to Russell Dalrymple. Kramer poses as Elaine's boyfriend.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;5: 'The Wallet' first.</em>" },
    ...
    { season: 4, episode: 23, title: "The Pilot, Part&nbsp;I", description: "George and Jerry finally produce their sitcom pilot. George is bothered by a spot on his lip. Elaine thinks Monk's only hires large-breasted servers.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;24: 'The Pilot, Part&nbsp;II' next.</em>" },
    { season: 4, episode: 24, title: "The Pilot, Part&nbsp;II", description: "George and Jerry finally produce their sitcom pilot. George is bothered by a spot on his lip. Elaine thinks Monk's only hires large-breasted servers.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;23: 'The Pilot, Part&nbsp;I' first.</em>" },
    ...
    { season: 5, episode: 18, title: "The Raincoats, Part&nbsp;I", description: "Elaine dates a 'close talker.' George sells Frank's old clothes. Kramer and Morty try to sell raincoats. Jerry and his girlfriend see 'Schindler's List.'<br><em>n.b. This is a double header, so you should watch Episode&nbsp;19: 'The Raincoats, Part&nbsp;II' next.</em>" },
    { season: 5, episode: 19, title: "The Raincoats, Part&nbsp;II", description: "Elaine dates a 'close talker.' George sells Frank's old clothes. Kramer and Morty try to sell raincoats. Jerry and his girlfriend see 'Schindler's List.'<br><em>n.b. This is a double header, so you should watch Episode&nbsp;18: 'The Raincoats, Part&nbsp;I' first.</em>" },
    ...
    { season: 6, episode: 14, title: "The Highlights of 100, Part&nbsp;I", description: "This highlight show looks back at the funniest moments from the first 99 episodes of the series.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;15: 'The Highlights of 100, Part&nbsp;II' next.</em>" },
    { season: 6, episode: 15, title: "The Highlights of 100, Part&nbsp;II", description: "This highlight show looks back at the funniest moments from the first 99 episodes of the series.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;14: 'The Highlights of 100, Part&nbsp;I' first.</em>" },
    ...
    { season: 7, episode: 14, title: "The Cadillac, Part&nbsp;I", description: "Jerry buys his parents a Cadillac, causing trouble in their retirement community. Kramer fights with a cable guy. George wants to date Marisa Tomei.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;15: 'The Cadillac, Part&nbsp;II' next.</em>" },
    { season: 7, episode: 15, title: "The Cadillac, Part&nbsp;II", description: "Jerry buys his parents a Cadillac, causing trouble in their retirement community. Kramer fights with a cable guy. George wants to date Marisa Tomei.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;14: 'The Cadillac, Part&nbsp;I' first.</em>" },
    ...
    { season: 9, episode: 21, title: "The Chronicle, Part&nbsp;I", description: "Look back at the funniest clips, most memorable quotes and unseen footage in this retrospective of the landmark series' entire run.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;22: 'The Chronicle, Part&nbsp;II' next.</em>" },
    { season: 9, episode: 22, title: "The Chronicle, Part&nbsp;II", description: "Look back at the funniest clips, most memorable quotes and unseen footage in this retrospective of the landmark series' entire run.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;21: 'The Chronicle, Part&nbsp;I' first.</em>" },
    { season: 9, episode: 23, title: "The Finale, Part&nbsp;I", description: "Jerry, George, Elaine, and Kramer are arrested for violating a 'good Samaritan' law, leading to a trial featuring characters from the show's past.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;24: 'The Finale, Part&nbsp;II' next.</em>" },
    { season: 9, episode: 24, title: "The Finale, Part&nbsp;II", description: "Jerry, George, Elaine, and Kramer are arrested for violating a 'good Samaritan' law, leading to a trial featuring characters from the show's past.<br><em>n.b. This is a double header, so you should watch Episode&nbsp;23: 'The Finale, Part&nbsp;I' first.</em>" },
]
